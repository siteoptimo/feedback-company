...
Issues can be reported in our [GitHub Repository](https://github.com/siteoptimo/feedback-company/issues).


== Installation ==
1. Upload the `feedback-company` folder to the `/wp-content/plugins/` directory.
